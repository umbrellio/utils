...
# Version but no is_deleted — the outer delete filter must then be omitted.
client.execute(<<~SQL)
  CREATE TABLE IF NOT EXISTS test_replacing_no_delete
  (id Int32, payload String, version Int32)
